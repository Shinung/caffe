...
model_name = "VGG_VOC0712_MOBILE_{}".format(job_name)
...
train_net_file = "{}/mobilenet_v2_train.prototxt".format(save_dir)
test_net_file = "{}/mobilenet_v2_test.prototxt".format(save_dir)
deploy_net_file = "{}/mobilenet_v2_deploy.prototxt".format(save_dir)
solver_file = "{}/mobilenet_v2_solver.prototxt".format(save_dir)
# snapshot prefix.
...
# conv8_2 ==> 3 x 3
# conv9_2 ==> 1 x 1
mbox_source_layers = ['conv4_3_dwise', 'fc7', 'conv6_2', 'conv7_2', 'conv8_2', 'conv9_2']
# in percent %
min_ratio = 20
max_ratio = 90
