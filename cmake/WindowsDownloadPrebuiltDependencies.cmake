...
if(MSVC)
  ...
  set(CAFFE_DEPENDENCIES_ROOT_DIR ${CMAKE_SOURCE_DIR}/../.caffe/dependencies CACHE PATH "Prebuild depdendencies root directory")
  ...
  message(STATUS "Dependencies Download Dir: ${CAFFE_DEPENDENCIES_DOWNLOAD_DIR}")
endif()
if(USE_PREBUILT_DEPENDENCIES)
    ...
    if(BUILD_python)
        ...
        if(${PYTHON_VERSION_MAJOR} EQUAL "3" AND ${PYTHON_VERSION_MINOR} GREATER "5")
            set(_pyver "${PYTHON_VERSION_MAJOR}5")
        else()
            set(_pyver ${PYTHON_VERSION_MAJOR}${PYTHON_VERSION_MINOR})
        endif()
        message(STATUS "_pyver: ${_pyver}")
    else()
